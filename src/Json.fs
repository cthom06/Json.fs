...
let private parseTrue = Parser.sequence "true" *>  Done (Bool true)
let private parseFalse = Parser.sequence "false" *> Done (Bool false)
let private parseBool = parseTrue <|> parseFalse
let private parseNull = Parser.sequence "null" *> Done Null

let private wsc c = Parser.eatWhite *> Parser.exactly c
